    ...
    mappings: {
      product: {
        properties: {
            ...
            domainCode: { 'type': 'text', 'index': true },
            languageId: { 'type': 'integer', 'index': true },
            productAwsImages: { 'type': 'text', 'index': false },
            productImage: { 'type': 'text', 'index': false },
            productModel: { 'type': 'text', 'index': true },
            productTitle: { 'type': 'text', 'index': true },
            productName: { 'type': 'text', 'index': true },
            productDescription: { 'type': 'text', 'index': true },
            ...
            productQuantityDiscount: { 'type': 'integer', 'index': true }, // è un array??????????
