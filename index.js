...
let body = {
    holy-products: {
        properties: {
            ...
            domainCode: { 'type': 'string', 'index': true },
            languageId: { 'type': 'integer', 'index': true },
            productAwsImages: { 'type': 'object', 'index': false },
            productImage: { 'type': 'string', 'index': false },
            productModel: { 'type': 'string', 'index': true },
            productTitle: { 'type': 'string', 'index': true },
            ...
            productType: { 'type': 'string', 'index': false },
            countryId: { 'type': 'integer', 'index': false },
            zoneId: { 'type': 'integer', 'index': false },
            productPath: { 'type': 'string', 'index': false },
...
async function run () {
  await client.indices.putMapping({ index: 'holy-products', type: 'product', body: body });
  ...
  await client.indices.refresh({ index: 'holy-products' })
}

run().catch(console.error).then(console.log('seeding completed'))
